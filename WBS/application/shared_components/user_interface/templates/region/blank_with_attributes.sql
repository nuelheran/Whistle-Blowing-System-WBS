...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14344337289386909406)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344337941333909407)
,p_plug_template_id=>wwv_flow_imp.id(14344337289386909406)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344338241670909407)
,p_plug_template_id=>wwv_flow_imp.id(14344337289386909406)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344337652467909407)
,p_plug_template_id=>wwv_flow_imp.id(14344337289386909406)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344338530340909407)
,p_plug_template_id=>wwv_flow_imp.id(14344337289386909406)
,p_name=>'Sub Regions'
