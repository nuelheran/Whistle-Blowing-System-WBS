...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14344317607103909388)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(14344321237242909389)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_static_id=>'sticky-header-on-mobile'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
,p_css_classes=>'js-pageStickyMobileHeader'
,p_template_types=>'PAGE'
,p_help_text=>'This will position the contents of the Breadcrumb Bar region position so it sticks to the top of the screen for small screens.'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344317947146909388)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344318228696909388)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344320661546909389)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344318497108909388)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344318858646909388)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344319099057909388)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344319755647909389)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344320039850909389)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344320961543909389)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344319449639909388)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344320337504909389)
,p_page_template_id=>wwv_flow_imp.id(14344317607103909388)
