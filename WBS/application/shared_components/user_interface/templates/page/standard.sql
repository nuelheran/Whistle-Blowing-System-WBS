...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14344328733724909391)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(14344331992311909395)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_static_id=>'sticky-header-on-mobile'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
,p_css_classes=>'js-pageStickyMobileHeader'
,p_template_types=>'PAGE'
,p_help_text=>'This will position the contents of the Breadcrumb Bar region position so it sticks to the top of the screen for small screens.'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344329046109909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344329300057909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344331416072909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344329599860909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344329888378909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344330216457909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344330577962909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344330811362909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344331690914909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344331082860909394)
,p_page_template_id=>wwv_flow_imp.id(14344328733724909391)
