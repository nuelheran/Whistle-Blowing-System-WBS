...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14344325286513909390)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(14344328652559909391)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_static_id=>'sticky-header-on-mobile'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
,p_css_classes=>'js-pageStickyMobileHeader'
,p_template_types=>'PAGE'
,p_help_text=>'This will position the contents of the Breadcrumb Bar region position so it sticks to the top of the screen for small screens.'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344325625286909390)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344325904615909390)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344328053799909391)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344326211379909390)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344326497492909390)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344326823263909390)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344327175474909391)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344327430204909391)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344328374771909391)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344327738532909391)
,p_page_template_id=>wwv_flow_imp.id(14344325286513909390)
