...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14344321322845909389)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(14344325225832909390)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_static_id=>'sticky-header-on-mobile'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_css_classes=>'js-pageStickyMobileHeader'
,p_template_types=>'PAGE'
,p_help_text=>'This will position the contents of the Breadcrumb Bar region position so it sticks to the top of the screen for small screens.'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344321601482909389)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344321973292909389)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344324657730909390)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344322212293909389)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344322516905909389)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344322796766909389)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344323750387909390)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344324014249909390)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344324927146909390)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344323089400909389)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344323435075909390)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344324311516909390)
,p_page_template_id=>wwv_flow_imp.id(14344321322845909389)
