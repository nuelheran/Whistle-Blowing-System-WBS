...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14344304369487909375)
,p_theme_id=>42
,p_name=>'Marquee'
,p_static_id=>'marquee'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(14344308259494909377)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_static_id=>'sticky-header-on-mobile'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
,p_css_classes=>'js-pageStickyMobileHeader'
,p_template_types=>'PAGE'
,p_help_text=>'This will position the contents of the Breadcrumb Bar region position so it sticks to the top of the screen for small screens.'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344304591400909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344304949457909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344307598962909377)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344305189094909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344305531944909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344305875280909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344306718633909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344307003593909377)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344307908601909377)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344306179032909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344306442651909376)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344307296822909377)
,p_page_template_id=>wwv_flow_imp.id(14344304369487909375)
