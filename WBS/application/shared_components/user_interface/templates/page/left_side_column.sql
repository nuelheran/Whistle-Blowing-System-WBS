...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14344313896074909387)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(14344317570197909388)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_static_id=>'sticky-header-on-mobile'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
,p_css_classes=>'js-pageStickyMobileHeader'
,p_template_types=>'PAGE'
,p_help_text=>'This will position the contents of the Breadcrumb Bar region position so it sticks to the top of the screen for small screens.'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344314236585909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344314559183909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344316908378909388)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344314848813909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344315152424909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344315411277909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344315996561909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344316357481909388)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344317279551909388)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344315680485909387)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14344316609425909388)
,p_page_template_id=>wwv_flow_imp.id(14344313896074909387)
