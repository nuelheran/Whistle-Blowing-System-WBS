...
,p_reference_id=>wwv_imp_util.get_subscription_id(1564403634518414297,2700,'TEMPLATE COMPONENT',8842,'mediaList','universal-theme')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(16144552447519793291)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_title=>'Avatar'
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(16144551892507793290)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_title=>'Badge'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344547678725909651)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344537720211909644)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(14344535312509909643)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(16144552447519793291)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344538363996909644)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14344535971506909643)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344537391418909644)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344537985994909644)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344538599462909645)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344539349091909645)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344538599462909645)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344540140333909645)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344538599462909645)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344538976925909645)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344538599462909645)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344539778331909645)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344538599462909645)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344535971506909643)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344537050049909644)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344535971506909643)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344536220461909643)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344535971506909643)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344536593272909643)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344535971506909643)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344541440312909646)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14344535662781909643)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(16144551892507793290)
,p_help_text=>'Enter an icon class or use the Pick Icon dialog to select the icon you want to add to display in the badge.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344540534864909646)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344541718822909647)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344543138204909648)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344543858688909648)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344543138204909648)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344543425069909648)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344543138204909648)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344544250203909649)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344543138204909648)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344541170573909646)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344542003403909647)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344542716509909647)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344542003403909647)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344542335503909647)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344542003403909647)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344540871039909646)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344534995526909642)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344535312509909643)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344535662781909643)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344544605266909649)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344544910131909649)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344544605266909649)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
,p_apexlang_name=>'2ColumnGrid'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344545345246909649)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344544605266909649)
,p_display_sequence=>20
,p_display_value=>'3 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--3cols'
,p_apexlang_name=>'3ColumnGrid'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344545770760909650)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344544605266909649)
,p_display_sequence=>30
,p_display_value=>'4 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--4cols'
,p_apexlang_name=>'4ColumnGrid'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344546093209909650)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344544605266909649)
,p_display_sequence=>40
,p_display_value=>'5 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--5cols'
,p_apexlang_name=>'5ColumnGrid'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344546542814909650)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344544605266909649)
,p_display_sequence=>50
,p_display_value=>'Horizontal Span'
,p_return_value=>'t-MediaList--horizontal'
,p_apexlang_name=>'horizontalSpan'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344546937381909650)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344547198919909651)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344546937381909650)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344534774311909642)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(16144755499676939919)
,p_plugin_id=>wwv_flow_imp.id(14344534033738909640)
,p_name=>'Link'
,p_static_id=>'LINK'
