...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14344488272525909574)
...
,p_reference_id=>wwv_imp_util.get_subscription_id(1564377533892414278,2700,'TEMPLATE COMPONENT',8842,'badge','universal-theme')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344489433102909576)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344488577958909576)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344489763783909577)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344491115817909578)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344491797618909579)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344491115817909578)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344491399081909578)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344491115817909578)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344492196036909579)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344491115817909578)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344492580954909579)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344493768773909580)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344492580954909579)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344493348324909579)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344492580954909579)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344492879856909579)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344492580954909579)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344489098990909576)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344490027849909578)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344490710001909578)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344490027849909578)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344490348312909578)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344490027849909578)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344488791259909576)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(15855970466263011765)
,p_plugin_id=>wwv_flow_imp.id(14344488272525909574)
,p_name=>'Link'
,p_static_id=>'LINK'
