...
,p_reference_id=>wwv_imp_util.get_subscription_id(1564386865908414285,2700,'TEMPLATE COMPONENT',8842,'comments','universal-theme')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(16144382505590941303)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_title=>'Avatar'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344505056645909601)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344498403942909594)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344500487667909596)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(14344503293253909600)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(16144382505590941303)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344501102464909599)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14344498703144909594)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344500269690909596)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344500864728909596)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344501391898909599)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344502116966909599)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344501391898909599)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344502960041909600)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344501391898909599)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344501770132909599)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344501391898909599)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344502576802909599)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344501391898909599)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344498703144909594)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344499803428909596)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344498703144909594)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344499065842909595)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344498703144909594)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344499425033909596)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344498703144909594)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344503599413909600)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344498156692909594)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
,p_attribute_type=>'SESSION STATE VALUE'
,p_is_required=>false
,p_sample_data_value=>'5 minutes ago'
,p_escape_mode=>'HTML'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344497490425909593)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
,p_apexlang_name=>'commentText'
,p_attribute_type=>'SESSION STATE VALUE'
,p_is_required=>true
,p_sample_data_value=>'Praesent vel felis rutrum erat elementum viverra sit amet non odio. Cras vel auctor eros, in malesuada dolor. Nulla tellus magna, ornare consectetur purus id, volutpat egestas felis. Proin lobortis risus massa, nec faucibus arcu malesuada a. Nunc sed'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344503293253909600)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344503924412909600)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'REPORT'
...
,p_sample_data_value=>'t-Comments--chat'
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_lov_type=>'STATIC'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344504265208909600)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344503924412909600)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
,p_apexlang_name=>'basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344504621957909600)
,p_plugin_attribute_id=>wwv_flow_imp.id(14344503924412909600)
,p_display_sequence=>20
,p_display_value=>'Chat (Speech Bubbles)'
,p_return_value=>'t-Comments--chat'
,p_apexlang_name=>'chatSpeechBubbles'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14344497799939909593)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(16144515173024042806)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_name=>'Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(16144514581519035349)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(16144570205189017228)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(16144722422901887999)
,p_plugin_id=>wwv_flow_imp.id(14344497054527909585)
