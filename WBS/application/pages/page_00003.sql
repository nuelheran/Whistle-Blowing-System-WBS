...
wwv_flow_imp_page.create_page(
 p_id=>3
,p_name=>'Report Submission Form'
,p_alias=>'REPORT-FORM'
,p_step_title=>'Report Submission Form'
,p_autocomplete_on_off=>'OFF'
,p_javascript_code=>wwv_flow_string.join(wwv_flow_t_varchar2(
'document.addEventListener(''DOMContentLoaded'', function() {',
'    const fields = [',
unistr('        { id: ''P3_NAMA_PELAPOR'', text: ''\D83D\DCDD Enter your name'' },'),
unistr('        { id: ''P3_TELP_PELAPOR'', text: ''\D83D\DCDE Example: 81234567890 (without the leading 0)'' },'),
unistr('        { id: ''P3_EMAIL_PELAPOR'', text: ''\2709\FE0F A valid and accessible email address (e.g. name@domain.com)'' },'),
unistr('        { id: ''P3_JABATAN_PELAPOR'', text: ''\D83C\DFE2 Employee / Business Unit / Vendor / Customer'' },'),
unistr('        { id: ''P3_NAMA_TERLAPOR'', text: ''\D83D\DC64 Full name of the reported person'' },'),
unistr('        { id: ''P3_JABATAN_TERLAPOR'', text: ''\D83D\DCCC Position/role of the reported person'' },'),
unistr('        { id: ''P3_WAKTU_KEJADIAN'', text: ''\D83D\DCC5 Example: January 2024 or 15 January 2024'' },'),
unistr('        { id: ''P3_LOKASI_KEJADIAN'', text: ''\D83D\DCCD Where the incident occurred, such as a branch, department, work area, or other relevant location'' },'),
unistr('        { id: ''P3_KRONOLOGIS_KEJADIAN'', text: ''\D83D\DCD6 Describe the sequence of events in detail (5W1H: what happened, who was involved, when, where, why, and how)'' }'),
'    ];',
'    ',
'    const timeouts = {};',
...
'/* -------------------------------------------------------------------------------------------- */',
''))
,p_step_template=>wwv_flow_imp.id(14345952485135166299)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344816900422969523)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344820993545969564)
,p_plug_name=>'<div class="form-section-header"><span class="step-num"> 1 </span> Reporter Details (Your identity will be kept confidential)</div>'
,p_static_id=>'div-class-form-section-header-span-class-step-num-1-span-reporter-details-your-identity-will-be-kept-confidential-div'
,p_parent_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344821185356969566)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344849330647370717)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344849389072370718)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344817267747969526)
,p_plug_name=>'Form'
,p_static_id=>'form'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14344816856648969522)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14344817099754969525)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(14344816900422969523)
...
,p_button_redirect_url=>'f?p=&APP_ID.:99:&SESSION.::&DEBUG.:RP,3,99::'
,p_icon_css_classes=>'fa-times-circle-o'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14344817031293969524)
...
'Your identity and the information you provide are guaranteed to remain <b>confidential</b> and <b>protected</b>. ',
'<br>',
'<br>',
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(14344850369527370727)
,p_branch_name=>'Go back to Page 99 (Landing Page)'
,p_branch_action=>'f?p=&APP_ID.:99:&SESSION.::&DEBUG.:RP,3,99::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14346971889616915738)
,p_name=>'P3_CURRENT_YEAR'
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819772827969551)
,p_name=>'P3_EMAIL_PELAPOR'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(14344820993545969564)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_prompt=>'Your Email'
...
,p_is_persistent=>'N'
,p_help_text=>'<p style="position: relative; max-width: 532px; margin-right: 60px;">An email address is required because we will follow up on your report through two-way communication.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'disabled', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820816206969562)
,p_name=>'P3_FILE_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_source=>'FILE_NAME'
,p_display_as=>'NATIVE_HIDDEN'
,p_is_persistent=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819245730969546)
,p_name=>'P3_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344849547794370719)
,p_name=>'P3_JABATAN_PELAPOR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(14344820993545969564)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819992860969554)
,p_name=>'P3_JABATAN_TERLAPOR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(14344821185356969566)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_prompt=>'Accused Position'
,p_placeholder=>'Position/role of the reported person '
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820300241969557)
,p_name=>'P3_KRONOLOGIS_KEJADIAN'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(14344849330647370717)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820263725969556)
,p_name=>'P3_LOKASI_KEJADIAN'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(14344849330647370717)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820776273969561)
,p_name=>'P3_MIME_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819503628969549)
,p_name=>'P3_NAMA_PELAPOR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(14344820993545969564)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_prompt=>'Your Name'
,p_placeholder=>'Enter your name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819903358969553)
,p_name=>'P3_NAMA_TERLAPOR'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(14344821185356969566)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819398809969548)
,p_name=>'P3_NOMOR_LAPORAN'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820660484969560)
,p_name=>'P3_PIC'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819354711969547)
,p_name=>'P3_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(14344817267747969526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14346971830609915737)
,p_name=>'P3_SUBMITTED_DATE'
,p_item_sequence=>50
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344819667350969550)
,p_name=>'P3_TELP_PELAPOR'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(14344820993545969564)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_prompt=>'Your Phone (+62)'
...
unistr('      \D83D\DCDE A phone number is required because we will follow up on your report through two-way communication.'),
'    </p>',
'  </div>',
'</div>'))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820570183969559)
,p_name=>'P3_UPLOAD'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(14344849389072370718)
,p_item_source_plug_id=>wwv_flow_imp.id(14344817267747969526)
,p_source=>'UPLOAD'
...
'<p><em>Please upload any relevant supporting evidence (documents, data, photos, chat screenshots, and audio/video recordings) to strengthen your report. ',
'Sufficient evidence helps speed up verification and investigation. The maximum file size is 8 MB.',
'<b>If you have multiple evidence files, please upload them all at the same time.</b>',
'</em></p>',
'',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14344820161202969555)
,p_name=>'P3_WAKTU_KEJADIAN'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(14344849330647370717)
...
,p_associated_item=>wwv_flow_imp.id(14344819667350969550)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14344850434666370728)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Email to Administrator'
,p_static_id=>'email-to-administrator'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_id NUMBER;',
'begin',
'    l_id := apex_mail.send (',
'        -- p_to                 => ''wbs-team@wbs.example.com'',',
'        p_to                 => ''manuelnicholasn@gmail.com'', ',
'        p_bcc                => ''manuelnicholasn@gmail.com'',',
'        -- p_to                 => ''reviewer@wbs.example.com'',',
'        p_from              =>  ''noreply@wbs.example.com'', ',
'        p_template_static_id => ''FORM_RECEIVED'',',
'        p_placeholders       => ''{'' ||',
'        ''    "NOMOR_LAPORAN":''    || apex_json.stringify( :P3_NOMOR_LAPORAN ) ||',
'        -- ''   ,"NAMA_PELAPOR":''        || apex_json.stringify( :P3_NAMA_PELAPOR ) ||',
'        ''   ,"EMAIL_PELAPOR":''       || apex_json.stringify( :P3_EMAIL_PELAPOR ) ||',
'        -- ''   ,"TELP_PELAPOR":''        || apex_json.stringify( :P3_TELP_PELAPOR ) ||',
'        -- ''   ,"TINDAKAN":''            || apex_json.stringify( :P3_TINDAKAN ) ||',
'        -- ''   ,"NAMA_TERLAPOR":''       || apex_json.stringify( :P3_NAMA_TERLAPOR ) ||',
'        -- ''   ,"JABATAN_TERLAPOR":''    || apex_json.stringify( :P3_JABATAN_TERLAPOR ) ||',
'        -- ''   ,"WAKTU_KEJADIAN":''      || apex_json.stringify( :P3_WAKTU_KEJADIAN ) ||',
'        -- ''   ,"LOKASI_KEJADIAN":''     || apex_json.stringify( :P3_LOKASI_KEJADIAN ) ||',
'        -- ''   ,"KRONOLOGIS_KEJADIAN":'' || apex_json.stringify( :P3_KRONOLOGIS_KEJADIAN ) ||',
'        -- ''   ,"NOMINAL":''             || apex_json.stringify( :P3_NOMINAL ) ||',
'        -- ''   ,"FILE":''                || apex_json.stringify( :P3_UPLOAD ) ||',
'        ''}'' );',
'        ',
'    -- FOR c1 IN (SELECT filename, blob_content, mime_type ',
'    --     FROM APEX_APPLICATION_TEMP_FILES) LOOP',
'',
...
,p_process_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_required_patch=>wwv_flow_imp.id(14344300039949909298)
,p_internal_uid=>65308555109929012
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14344850490079370729)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Email to Submitter'
,p_static_id=>'email-to-submitter'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_id NUMBER; ',
'    l_original_filename VARCHAR(255);',
'begin ',
'    l_id := apex_mail.send (',
'        p_to                 => :P3_EMAIL_PELAPOR,',
'        p_from               => ''noreply@wbs.example.com'',',
'        p_template_static_id => ''FORM_SUBMITTED'',',
'        p_placeholders       => ''{'' ||',
'        ''    "NOMOR_LAPORAN":''    || apex_json.stringify( :P3_NOMOR_LAPORAN ) ||',
'        ''   ,"NAMA_PELAPOR":''        || apex_json.stringify( :P3_NAMA_PELAPOR ) ||',
'        ''   ,"EMAIL_PELAPOR":''       || apex_json.stringify( :P3_EMAIL_PELAPOR ) ||',
...
'',
'        BEGIN ',
'        SELECT SUBSTR(c1.filename, INSTR(c1.filename, ''/'', -1) + 1) INTO l_original_filename',
'            FROM dual;',
'        EXCEPTION',
'            WHEN NO_DATA_FOUND THEN',
'                l_original_filename := c1.filename;',
'        END;',
'',
'        APEX_MAIL.ADD_ATTACHMENT(',
'            p_mail_id    => l_id,',
'            p_attachment => c1.blob_content,',
'            p_filename   => l_original_filename,',
'            p_mime_type  => c1.mime_type);',
'        END LOOP;',
'        ',
'    COMMIT;',
...
,p_process_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_required_patch=>wwv_flow_imp.id(14344300039949909298)
,p_internal_uid=>65308610522929013
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14344817364562969527)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(14344817267747969526)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Report Submission Form'
,p_static_id=>'initialize-form-report-submission-form'
,p_internal_uid=>65275485006527811
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14344849691779370721)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(14344849615798370720)
,p_process_type=>'NATIVE_PLSQL'
...
'        DELETE FROM APEX_APPLICATION_TEMP_FILES WHERE name = :P3_UPLOAD;',
'        ',
'    ELSE',
'        -- Insert without file',
'        INSERT INTO XTD_WBS (',
...
'    END IF;',
'    ',
'    :P3_NOMOR_LAPORAN := v_nomor_laporan;',
'    ',
'EXCEPTION',
'    WHEN OTHERS THEN',
'        IF :P3_UPLOAD IS NOT NULL THEN',
...
,p_required_patch=>wwv_flow_imp.id(14344300039949909298)
,p_internal_uid=>65307812222929005
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14345424394208289952)
,p_process_sequence=>30
,p_parent_process_id=>wwv_flow_imp.id(14344849615798370720)
,p_process_type=>'NATIVE_PLSQL'
...
'    IF :P3_UPLOAD IS NOT NULL AND :P3_UPLOAD != ''[]'' THEN',
'        ',
'        IF :P3_UPLOAD LIKE ''{%'' OR :P3_UPLOAD LIKE ''[%'' THEN',
'            -- Parse JSON array (for APEX 22.2+)',
'            FOR rec IN (',
'                SELECT ',
'                    JSON_VALUE(value, ''$.name'') AS temp_name',
'                FROM JSON_TABLE(:P3_UPLOAD, ''$[*]'' COLUMNS (value VARCHAR2(4000) PATH ''$''))',
'            ) LOOP',
'                SELECT BLOB_CONTENT, MIME_TYPE, FILENAME',
'                INTO v_blob_content, v_mime_type, v_file_name',
'                FROM APEX_APPLICATION_TEMP_FILES',
...
'                FROM TABLE(APEX_STRING.split(:P3_UPLOAD, '':''))',
...
,p_process_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_process_success_message=>'Your report has been created and submitted successfully.'
,p_internal_uid=>65882514651848236
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14346971989304915739)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'from', '&P0_EMAIL_FROM.',
  'placeholder_values', '{"REPORT_NUMBER":"&P3_NOMOR_LAPORAN.","REPORTER_NAME":"&P3_NAMA_PELAPOR.","REPORTER_EMAIL":"&P3_EMAIL_PELAPOR.","ACCUSED_NAME":"&P3_NAMA_TERLAPOR.","ACCUSED_POSITION":"&P3_JABATAN_TERLAPOR.","INCIDENT_DATE":"&P3_WAKTU_KEJADIAN.","INCIDENT_LOCATION":"'
||'&P3_LOKASI_KEJADIAN.","KRONOLOGI_SUMMARY":"&P3_KRONOLOGIS_KEJADIAN.","ATTACHMENT_STATUS":"&P3_STATUS.","APP_URL":"&P0_LOGIN_LINK.","CURRENT_YEAR":"&P3_CURRENT_YEAR."}',
  'send_immediately', 'N',
  'to', '&P0_EMAIL_ADMIN.')).to_clob
,p_process_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_internal_uid=>67430109748474023
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14346971282510915732)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'from', '&P0_EMAIL_FROM.',
  'placeholder_values', '{"REPORT_NUMBER":"&P3_NOMOR_LAPORAN.","REPORTER_EMAIL":"&P3_EMAIL_PELAPOR.","REPORT_DATE":"&P3_SUBMITTED_DATE.","ACCUSED_NAME":"&P3_NAMA_TERLAPOR.","ACCUSED_POSITION":"&P3_JABATAN_TERLAPOR.","INCIDENT_DATE":"&P3_WAKTU_KEJADIAN.","CURRENT_YEAR":"&P3_C'
||'URRENT_YEAR."}',
  'send_immediately', 'N',
  'to', '&P3_EMAIL_PELAPOR.')).to_clob
,p_process_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_internal_uid=>67429402954474016
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14344849615798370720)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(14344817031293969524)
,p_internal_uid=>65307736241929004
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14344850099099370725)
,p_process_sequence=>10
,p_parent_process_id=>wwv_flow_imp.id(14344849615798370720)
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_required_patch=>wwv_flow_imp.id(14344300039949909298)
,p_internal_uid=>65308219542929009
);
